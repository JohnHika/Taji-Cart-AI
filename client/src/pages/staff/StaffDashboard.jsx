  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold mb-2 text-charcoal dark:text-white">Staff Dashboard</h1>
          <p className="text-brown-500 dark:text-white/40">Manage store operations and delivery services</p>
        </div>
      ...
      {/* Dashboard Sections */}
      <div className="mb-12">
        <h2 className="text-xl font-semibold mb-6 text-charcoal dark:text-white/70 border-b border-brown-100 dark:border-dm-border pb-2">
          Pickup Management
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <h2 className="text-lg font-medium mb-2 text-charcoal dark:text-white">Verify Pickup</h2>
          ...
          >
            ...
            <h2 className="text-lg font-medium mb-2 text-charcoal dark:text-white">Pending Pickups</h2>
            <p className="text-brown-500 dark:text-white/40 text-sm">
          ...
          >
            ...
            <h2 className="text-lg font-medium mb-2 text-charcoal dark:text-white">Verification History</h2>
            <p className="text-brown-500 dark:text-white/40 text-sm">
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <h2 className="text-lg font-medium mb-2 text-charcoal dark:text-white">Pending Orders</h2>
            <p className="text-brown-500 dark:text-white/40 text-sm">
          ...
          >
            ...
            <h2 className="text-lg font-medium mb-2 text-charcoal dark:text-white">Active Deliveries</h2>
            <p className="text-brown-500 dark:text-white/40 text-sm">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Link 
            ...
            className="bg-white dark:bg-dm-card p-4 rounded-lg shadow-sm hover:shadow-md transition-all flex items-center border border-brown-100 dark:border-dm-border"
          >
            ...
            <span className="text-charcoal dark:text-white font-medium">Dispatched Orders</span>
          </Link>
          ...
          >
            ...
            <span className="text-charcoal dark:text-white font-medium">Completed Orders</span>
          </Link>
          ...
          >
            ...
            <span className="text-charcoal dark:text-white font-medium">Dashboard Overview</span>
          </Link>
          ...
          >
            ...
            <span className="text-charcoal dark:text-white font-medium">Users Management</span>
          </Link>
        </div>
      </div>
    </div>
