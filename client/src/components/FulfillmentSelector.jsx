  ...
  return (
    <div className="mt-4 mb-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          <FaTruck className={`text-2xl mb-2 ${fulfillmentType === 'delivery' ? 'text-primary-100' : 'text-brown-400'}`} />
          <div className="font-medium text-center">Delivery</div>
          <p className="text-sm text-center text-brown-400 dark:text-white/40 mt-1">
        ...
        >
          <FaStore className={`text-2xl mb-2 ${fulfillmentType === 'pickup' ? 'text-primary-100' : 'text-brown-400'}`} />
