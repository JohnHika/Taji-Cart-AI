    ...
    <section className='fixed top-0 right-0 bottom-0 left-0 bg-neutral-800 bg-opacity-70 z-50 flex items-center justify-center p-4'>
        <div className='w-full max-w-5xl bg-white dark:bg-gray-800 p-4 rounded transition-colors duration-200'>
            <div className='flex items-center justify-between gap-3'>
                <h1 className='font-semibold text-gray-900 dark:text-white transition-colors duration-200'>Edit Sub Category</h1>
            ...
            <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                    <div className='grid gap-1'>
                        ...
                        <input 
                            ...
                            className='p-3 bg-blue-50 dark:bg-gray-700 border dark:border-gray-600 outline-none focus-within:border-primary-200 dark:focus-within:border-primary-300 rounded text-gray-900 dark:text-white transition-colors duration-200'
                        />
                    </div>
                    <div className='grid gap-1'>
