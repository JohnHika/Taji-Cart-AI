            ...
            <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                    <div className='grid gap-1'>
                        ...
                        <input 
                            ...
                            className='p-3 bg-plum-50 dark:bg-dm-card-2 border dark:border-gray-600 outline-none focus-within:border-plum-500 dark:focus-within:border-plum-400 rounded text-gray-900 dark:text-white transition-colors duration-200'
                        />
                    </div>
                    <div className='grid gap-1'>
