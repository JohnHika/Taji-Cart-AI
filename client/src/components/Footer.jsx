      ...
      <div className="container mx-auto px-4 py-10 sm:py-12">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr]">
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 text-2xl">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-plum-600 transition-colors hover:text-plum-500 dark:text-plum-400 dark:hover:text-plum-300"
          ...
          <div className="rounded-3xl border border-gold-200/80 bg-white/80 p-5 shadow-sm dark:border-gold-500/20 dark:bg-dm-card/90">
            ...
            <p className="mt-3 text-sm font-medium text-charcoal dark:text-white">{nawiriBrand.location}</p>
            <p className="mt-2 text-sm text-brown-600 dark:text-white/70">
