...
const UserActiveCampaigns = () => {
  ...
  return (
    <div className="mt-4 mb-6 bg-white dark:bg-dm-card rounded-lg border border-brown-100 dark:border-dm-border shadow-sm overflow-hidden">
      <div className="p-3 bg-primary-200/10 border-b border-brown-100 dark:border-dm-border flex justify-between items-center">
        <h3 className="font-medium text-charcoal dark:text-white flex items-center">
      ...
      {loading ? (
        ...
        <div className="divide-y divide-brown-100 dark:divide-dm-border">
          {campaigns.map(campaign => {
            ...
            return (
              <div key={campaign._id} className="p-3 hover:bg-ivory dark:hover:bg-dm-card-2 transition-colors">
                <div className="flex items-center">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start">
                      <h4 className="font-medium text-charcoal dark:text-white truncate">{campaign.title}</h4>
                    ...
                    <div className="w-full bg-brown-100 dark:bg-dm-card-2 rounded-full h-1.5 mt-2">
                      <div 
