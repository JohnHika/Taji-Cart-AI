...
const CardProduct = ({ data }) => {
  ...
  return (
    ...
    >
      <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-gradient-to-br from-plum-50 via-white to-blush-50 shadow-sm dark:from-dm-card-2 dark:via-dm-card dark:to-dm-card">
